...
Citizen.CreateThread(function()
	exports['rsg-core']:createPrompt('stdenis-buy-ticket', vector3(2662.98, -1542.05, 45.97), RSGCore.Shared.Keybinds['ENTER'], 'Buy a Ticket', {
		type = 'server',
		event = 'qc-guarma:server:buyticket',
	...
	exports['rsg-core']:createPrompt('stdenis-guarma', vector3(2663.5056, -1543.155, 45.969764), RSGCore.Shared.Keybinds['J'], 'Travel to Guarma', { -- [J]
		type = 'client',
		event = 'qc-guarma:client:guarma_boat',
		args = {},
	})
...
Citizen.CreateThread(function()
	...
	exports['rsg-core']:createPrompt('guarma-stdenis', vector3(1268.6583, -6851.772, 43.318504), RSGCore.Shared.Keybinds['J'], 'Travel to St Denis', {
		type = 'client',
		event = 'qc-guarma:client:stdenis_boat',
		args = {},
	})
...
RegisterNetEvent("qc-guarma:client:guarma_boat")
AddEventHandler("qc-guarma:client:guarma_boat", function()
	local hasItem = RSGCore.Functions.HasItem('boatticket', 1)
	if hasItem then
		TriggerServerEvent('qc-guarma:server:removeItem', 'boatticket', 1)
		-- tp bateau
		DoScreenFadeOut(500)
		Wait(1000)
...
RegisterNetEvent("qc-guarma:client:stdenis_boat")
AddEventHandler("qc-guarma:client:stdenis_boat", function()
	local hasItem = RSGCore.Functions.HasItem('boatticket', 1)
	if hasItem then
		-- tp bateau
